...
@Path("quibbles")	// http://localhost:8080/quibble-rs-webservice/webapi/quibbles
public class QuibbleResource {
	...
	@GET
	@Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
	@Path("{quibbleId}")	// http://localhost:8080/quibble-rs-webservice/webapi/quibbles/1
	...
	@GET
	@Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
	@Path("{quibbleId}/author")	// http://localhost:8080/quibble-rs-webservice/webapi/quibbles/1/author
	...
	@POST
	@Path("quibble")	// http://localhost:8080/quibble-rs-webservice/webapi/quibbles/quibble
